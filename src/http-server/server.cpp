...
int main() {
    ...
    while (true) {
        ...
        std::string response = "HTTP/1.1 200 OK\r\nContent-Type: text/html\r\n\r\n<!DOCTYPE html><html lang=\"en\"><title>HTTP-Server</title><head><meta charset=\"UTF-8\"></head><body><h1>HTTP/1.1 200 OK</h1><h2>Host: localhost</h2><p>Content-Type: text/html</p><button onclick=\"clickme()\">Click me!</button><script type=\"text/javascript\">function clickme() {\n\tvar colors = [\'blue\', \'grey\', \'black\', \'white\', \'red\', \'green\', \'#aaa\', \'#FFAACC\', \'rgb(122,111,110)\'];\n\tdocument.body.style.backgroundColor = colors[Math.floor(Math.random() * colors.length)];\n\talert(\"Page color will be changed! (or, if you are lucky, the same one as now)\");\n}</script></body></html>";
